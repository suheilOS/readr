...
- Phase 4: implemented locally. Desk cards and Library rows now use stored visual metadata with responsive media, portrait book covers, author/source hierarchy, compact finish dates and note previews, lazy image loading, broken-image handling, and the existing lifecycle actions.
- Phases 5–7: planned, not implemented by this change.
